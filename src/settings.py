...
PREVIEW_IMAGE_ID: int = 7909518
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/bangladeshi-license-plate-recognition-localization"
...
PAPER: Optional[Union[str, List[str], Dict[str, str]]] = ["https://link.springer.com/chapter/10.1007/978-981-16-6636-0_8"]
...
ORGANIZATION_URL: Optional[Union[str, List[str]]] = ["https://www.kuet.ac.bd/"]
